...
export const PATH_TOKEN = paths.dashboard.root; // as '/dashboard/create-token'
export const PATH_ADVANCED = paths.dashboard.token.advanced.mint; // as '/dashboard/create-token'
