...
export const _tokenProfileCover = {
  id: _mock.id(1),
  tokenName: 'Token 1',
  tokenSymbol: 'TKN1',
  tokenAddress: '249uXZ4eoSGzZdw4qS9CGobGoa5bw7wLyMytcx2YHwMR',
  coverUrl: _mock.image.cover(9),
  tokenPictureUrl: _mock.image.avatar(2),
};

export const _tokenInformation = {
  id: _mock.id(1),
